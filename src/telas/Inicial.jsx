    ...
    return (
        <div className="flex flex-col gap-10 p-4">
            ...
            <div className="flex flex-col gap-2">
                ...
                <input className={estiloInputText} type="text" id="grupo1" />

                <label className="font-medium" htmlFor="grupo2">Nome do Grupo 2</label>
                <input className={estiloInputText} type="text" id="grupo2" />
            </div>

            <RadiosPontos />

            <button className="bg-red-700 h-15 w-30 mt-10 m-auto font-bold rounded-md">Iniciar</button>
        </div>
    )
}